            ...
            <div class="row documentos_vacante">
                 <?php foreach($detalle_documentos as $documento): ?>
                    <div class="col-md-3 text-center" data-id-documento="<?php echo $documento->id_documento; ?>">
                        ...
                        <a href="javascript:void(0);" class="btn btn-warning waves-effect waves-light btn-xs m-b-5 ddc" data-ic="0" id="df_<?php echo $documento->id_documento; ?>" target="_blank">Descargar</a>
                    </div>
                <?php endforeach; ?>
            </div>
