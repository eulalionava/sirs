var CandidatosPanel_view = Backbone.View.extend({
    ...
    ,events:{
        "click .tab_control": "f_validarCambioTabs",
    ...
    f_finalizarProcesoSolicitud: function(e){
        var _this = this;
        if(_this.f_validarInfoGral() < 0){
            return -1;
        }
        
        if(_this.f_validarCuestionario(".panel-nach-pregunta") < 0){
            return -1;
        }
        
        if(_this.f_validarCuestionario(".panel-nach-pregunta-ortografia") < 0){
            return -1;
        }
        
        if(_this.f_validarCuestionario(".panel-nach-pregunta-typing") < 0){
            return -1;
        }
        
        if(_this.f_validarCargaDocs() < 0){
            return -1;
        }
    ...
    f_avanzarProceso: function(e){
        ...
        if(ls_currentStep === 'info-gral'){
            _this.f_validarInfoGral();
        }
        
        if(ls_currentStep === 'cuestionario'){
            _this.f_validarCuestionario(".panel-nach-pregunta");
        }
        
        if(ls_currentStep === 'prueba-ortografia'){
            _this.f_validarCuestionario(".panel-nach-pregunta-ortografia");
        }
        
        if(ls_currentStep === 'prueba-typing'){
            _this.f_validarCuestionario(".panel-nach-pregunta-typing");
        }        
    },
    ...
    f_validarCambioTabs: function(e){
        var _this = this;
        e.stopPropagation();
        lo_currentItem = e.currentTarget;
